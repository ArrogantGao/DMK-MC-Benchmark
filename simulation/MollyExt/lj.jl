# check the shifted lennard jones potential

using Molly
using Plots
include(joinpath(@__DIR__, "../MollyExt/truncated_lj.jl"))

inter_nonshifted = ShiftedLennardJones(cutoff=DistanceCutoff(1.122462048309373u"nm"), shift = false)
inter_shifted = ShiftedLennardJones(cutoff=DistanceCutoff(1.122462048309373u"nm"), shift = true)
