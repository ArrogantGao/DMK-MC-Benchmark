...
function main()
    ...
    sim = MetropolisMonteCarloPDMK(;
        ...
        reconstruct = 5000,
        print_interval = 100,
        energy_file = joinpath(@__DIR__, "energy_mc_accuracy.csv"),
        check_accuracy = true,
        n_check = 100,
        pme = ParticleMeshEwald.PME(2.0, (9.4, 9.4, 9.4), 3.0, 1000),
        accuracy_file = joinpath(@__DIR__, "dE_mc_accuracy.csv")
    )
